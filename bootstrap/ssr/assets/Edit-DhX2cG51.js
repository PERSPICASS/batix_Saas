...
import "ziggy-js";
function SuppliersEdit({ supplier, shops }) {
  const route = useRoute();
  const { data, setData, put, processing, errors } = useForm({
    shop_ids: supplier.shops.map((s) => s.id),
    name: supplier.name,
  ...
  return /* @__PURE__ */ jsxs(Authenticated, { header: /* @__PURE__ */ jsx("h1", { className: "text-xl font-semibold text-white", children: "Modifier fournisseur" }), children: [
    /* @__PURE__ */ jsx(Head_default, { title: "Modifier fournisseur" }),
