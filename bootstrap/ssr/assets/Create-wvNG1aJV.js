...
function Create() {
  ...
  return /* @__PURE__ */ jsxs(Authenticated, { header: /* @__PURE__ */ jsx("h1", { className: "text-xl font-semibold text-white", children: "Nouvelle Boutique" }), children: [
    /* @__PURE__ */ jsx(Head_default, { title: "Nouvelle Boutique" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-3 border-t border-white/10 pt-4", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: processing ? "Création..." : "Créer la boutique"
          }
        )
      ] })
    ] }) })
