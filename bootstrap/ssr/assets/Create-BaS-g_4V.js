...
function UsersCreate({ shops }) {
  ...
  return /* @__PURE__ */ jsxs(Authenticated, { header: /* @__PURE__ */ jsx("h1", { className: "text-xl font-semibold text-white", children: "Nouvel utilisateur" }), children: [
    /* @__PURE__ */ jsx(Head_default, { title: "Nouvel utilisateur" }),
    /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-4xl", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6 rounded-2xl border border-white/10 bg-white/5 p-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "password", className: "block text-sm font-medium text-slate-200", children: "Mot de passe *" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "password",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-3 border-t border-white/10 pt-4", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: processing ? "Création..." : "Créer l'utilisateur"
          }
        )
      ] })
    ] }) })
