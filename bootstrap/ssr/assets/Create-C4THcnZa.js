...
function PurchasesCreate({ code_user, suppliers, products, currency }) {
  ...
  const submit = (e) => {
    e.preventDefault();
    data.items = items;
    post(route("purchases.store", { code_user }));
  };
  return /* @__PURE__ */ jsxs(Authenticated, { children: [
    /* @__PURE__ */ jsx(Head_default, { title: "Nouveau bon de commande" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx(
          Link_default,
          {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-white", children: "Nouveau bon de commande" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-slate-400", children: "Créez une commande fournisseur" })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  required: true,
                  children: [
                    /* @__PURE__ */ jsx("option", { value: "", children: "Sélectionner un fournisseur" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-slate-800/50 p-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("h2", { className: "flex items-center gap-2 text-lg font-semibold text-white", children: [
              /* @__PURE__ */ jsx(Package, { className: "size-5" }),
              "Articles"
            ] }),
            /* @__PURE__ */ jsxs(
              "button",
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-6", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx(InputLabel, { value: "Quantité *" }),
                    /* @__PURE__ */ jsx(
                      TextInput,
                      {
                        type: "number",
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-center justify-between text-sm", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-slate-400", children: "Total de la ligne:" }),
                  /* @__PURE__ */ jsx("span", { className: "font-semibold text-amber-300", children: formatCurrency(calculateLineTotal(item)) })
                ] })
              ]
            },
            index
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-slate-800/50 p-6", children: [
          /* @__PURE__ */ jsx("h2", { className: "mb-4 text-lg font-semibold text-white", children: "Récapitulatif" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-slate-800/50 p-6", children: [
          /* @__PURE__ */ jsx("h2", { className: "mb-4 text-lg font-semibold text-white", children: "Notes" }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx(InputError, { message: errors.internal_notes, className: "mt-2" })
            ] })
          ] })
        ] }),
