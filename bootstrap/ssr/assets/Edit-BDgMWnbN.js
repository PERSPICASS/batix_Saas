...
import "ziggy-js";
function CustomersEdit({ customer, shops }) {
  ...
  return /* @__PURE__ */ jsxs(Authenticated, { header: /* @__PURE__ */ jsx("h1", { className: "text-xl font-semibold text-white", children: "Modifier client" }), children: [
    /* @__PURE__ */ jsx(Head_default, { title: "Modifier client" }),
    /* @__PURE__ */ jsxs("form", { onSubmit, className: "space-y-4 rounded-2xl border border-white/10 bg-white/5 p-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
        /* @__PURE__ */ jsxs("label", { className: "block space-y-1 text-sm text-slate-200 md:col-span-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400", children: "La boutique ne peut pas être modifiée" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-2", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: processing ? "Enregistrement..." : "Sauvegarder"
          }
        )
      ] })
    ] })
