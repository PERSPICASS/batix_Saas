...
function BlogEdit({ post }) {
  ...
  return /* @__PURE__ */ jsxs(Authenticated, { children: [
    /* @__PURE__ */ jsx(Head_default, { title: `Modifier — ${post.title_fr}` }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-white", children: "Modifier l'article" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-white/60", children: post.slug })
        ] })
      ] }),
      /* @__PURE__ */ jsx("form", { onSubmit: handleSubmit, className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/5 p-6 space-y-5", children: [
            ...
            post.cover_image && /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs text-white/40", children: "Image actuelle" }),
              /* @__PURE__ */ jsx(
                "img",
                {
            ...
            /* @__PURE__ */ jsx(Field, { label: "Nouvelle image de couverture", error: errors.cover_image, children: /* @__PURE__ */ jsx(
              "input",
              {
                type: "file",
                accept: "image/*",
            ...
            /* @__PURE__ */ jsxs("label", { className: "flex cursor-pointer items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-sm text-white/70", children: "Publié" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs(
            "button",
