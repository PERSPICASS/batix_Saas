...
/**
 * Ce que ces tests gardent : le prestataire reçoit un code pays ISO et un numéro
 * international E.164 sans indicatif concaténé deux fois. Le piège est que le
 * préfixe national dépend du pays, donc un
...
describe('normalizePhone', () => {
    it('drops the trunk prefix where the country uses one', () => {
        ...
        expect(fr?.international).toBe('+33612345678');
    });
