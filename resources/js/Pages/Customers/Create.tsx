...
export default function CustomersCreate({ shops }: Props) {
    ...
    return (
        <AuthenticatedLayout header={<h1 className="text-xl font-semibold text-slate-900 dark:text-white">{t.customers.actions.new}</h1>}>
            ...
            <form onSubmit={onSubmit} className="space-y-4 rounded-2xl border border-gray-200 bg-white p-6 dark:border-white/10 dark:bg-white/5">
                <div className="grid gap-4 md:grid-cols-2">
                    <label className="block space-y-1 text-sm text-slate-700 dark:text-slate-200 md:col-span-2">
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">{t.common.form.shopHint}</p>
                    ...
                    <label className="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-200 md:col-span-2">
                        <input
                            ...
                            className="rounded border border-gray-300 bg-white dark:border-white/15 dark:bg-slate-900/70"
                        />
