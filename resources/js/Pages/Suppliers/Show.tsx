        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-semibold text-slate-900 dark:text-white">Détails du fournisseur</h1>
                    <Link
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div className="space-y-6 lg:col-span-2">
                        ...
                        <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-white/10 dark:bg-white/5">
                            <div className="mb-6 flex items-center justify-between">
                                <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Informations générales</h2>
                                {supplier.is_active ? (
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm text-slate-500 dark:text-slate-400">Nom du contact</p>
                                        <p className="font-medium text-slate-700 dark:text-slate-200">{supplier.name}</p>
                                        {supplier.company_name && (
                                            <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">{supplier.company_name}</p>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-1">
                                            {supplier.phone && (
                                                <p className="font-medium text-slate-700 dark:text-slate-200">Fixe: {supplier.phone}</p>
                                            )}
                                            {supplier.mobile && (
                                                <p className="font-medium text-slate-700 dark:text-slate-200">Mobile: {supplier.mobile}</p>
                                            )}
                                ...
                                {(supplier.address || supplier.city) && (
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-1">
                                                {supplier.address && (
                                                    <p className="text-slate-700 dark:text-slate-200">{supplier.address}</p>
                                                )}
                                                <p className="text-slate-700 dark:text-slate-200">
                                                    {supplier.city && `${supplier.city}`}
                                                    {supplier.postal_code && ` ${supplier.postal_code}`}
                                                </p>
                                                <p className="text-slate-600 dark:text-slate-300">{supplier.country}</p>
                                            </div>
                                        </div>
                                    </div>
                                )}
                                ...
                                {supplier.website && (
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm text-slate-500 dark:text-slate-400">Site web</p>
                                            <a
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-white/10 dark:bg-white/5">
                            <h3 className="mb-4 text-sm font-semibold text-slate-900 dark:text-white">Informations fiscales</h3>
                            <div className="space-y-3">
                                <div>
                                    <p className="text-xs text-slate-500 dark:text-slate-400">ICE / N° Fiscal</p>
                        ...
                        {/* Statistiques */}
                        <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-white/10 dark:bg-white/5">
                            <h3 className="mb-4 text-sm font-semibold text-slate-900 dark:text-white">Statistiques</h3>
                            <div className="space-y-3">
                                <div>
                                    <p className="text-xs text-slate-500 dark:text-slate-400">Produits fournis</p>
