...
export default function EditRecurringInvoice({ recurringInvoice, customers, products }: { recurringInvoice: any; customers: Customer[]; products: Product[] }) {
    ...
    return (
        <AuthenticatedLayout header={<h1 className="text-xl font-semibold text-white">Modifier le cycle</h1>}>
            <Head title="Modifier la facture récurrente" />
                ...
                <section className="space-y-4 xl:col-span-2">
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-200 mb-2">Date de fin</label>
                                <input
                                    type="date"
