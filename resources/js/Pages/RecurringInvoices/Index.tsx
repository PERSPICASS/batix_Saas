...
export default function RecurringInvoicesIndex({ recurringInvoices, filters = {} }: { recurringInvoices: any; filters?: any }) {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (ri: RecurringInvoice) => (
                <span className="text-sm text-slate-400">{new Date(ri.next_invoice_date).toLocaleDateString('fr-FR')}</span>
            ),
        },
        {
            key: 'total',
            ...
            render: (ri: RecurringInvoice) => (
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        title={ri.is_active ? 'Pause' : 'Reprendre'}
                    >
    ...
    return (
        <AuthenticatedLayout header={<h1 className="text-xl font-semibold text-white">Factures Récurrentes</h1>}>
                ...
                <div className="space-y-4">
                    <div className="flex flex-wrap items-center gap-4">
                        <div className="relative flex-1 min-w-64">
                            ...
                            <input
                                type="text"
                                placeholder="Rechercher par cycle ou client..."
                                value={searchTerm}
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 overflow-hidden">
                    ...
                    {recurringInvoices.data?.length === 0 && (
                        <div className="px-6 py-12 text-center text-slate-400">
                            Aucune facture récurrente. Créez votre premier cycle pour commencer.
                        </div>
                    )}
                </div>
