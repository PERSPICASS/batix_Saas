                ...
                >
                    <form onSubmit={handleStep1} className="space-y-3">
                        <div>
                            ...
                            <TextInput id="name" value={name} className="mt-1 block w-full border border-[#cfc3ac] bg-white text-slate-900 placeholder-slate-400" autoComplete="name" isFocused onChange={(e) => setName(e.target.value)} required placeholder={t.auth.form.fullNamePlaceholder} />
                        ...
                        <div>
                            ...
                            <TextInput id="email" type="email" value={email} className="mt-1 block w-full border border-[#cfc3ac] bg-white text-slate-900 placeholder-slate-400" autoComplete="username" onChange={(e) => setEmail(e.target.value)} required placeholder={t.auth.form.emailPlaceholder} />
                        ...
                        <div>
                            ...
                            <div className="relative mt-1">
                                <TextInput id="password" type={showPassword ? 'text' : 'password'} value={password} className="block w-full border border-[#cfc3ac] bg-white pr-10 text-slate-900 placeholder-slate-400" autoComplete="new-password" onChange={(e) => setPassword(e.target.value)} required placeholder={t.auth.form.passwordPlaceholder} />
                        ...
                        <div>
                            ...
                            <div className="relative mt-1">
                                <TextInput id="password_confirmation" type={showPasswordConfirmation ? 'text' : 'password'} value={passwordConfirmation} className="block w-full border border-[#cfc3ac] bg-white pr-10 text-slate-900 placeholder-slate-400" autoComplete="new-password" onChange={(e) => setPasswordConfirmation(e.target.value)} required placeholder={t.auth.form.passwordPlaceholder} />
            ...
            >
                <form onSubmit={handleStep3} className="space-y-3">
                    <div>
                        ...
                        <TextInput id="shop_name" value={shopName} className="mt-1 block w-full border border-[#cfc3ac] bg-white text-slate-900 placeholder-slate-400" isFocused onChange={(e) => setShopName(e.target.value)} required placeholder={t.auth.shop.namePlaceholder} />
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <TextInput id="shop_city" value={shopCity} className="mt-1 block w-full border border-[#cfc3ac] bg-white text-slate-900 placeholder-slate-400" onChange={(e) => setShopCity(e.target.value)} placeholder={t.auth.shop.registerCityPlaceholder} />
                        ...
                        <div>
                            ...
                            <TextInput id="shop_phone" value={shopPhone} className="mt-1 block w-full border border-[#cfc3ac] bg-white text-slate-900 placeholder-slate-400" onChange={(e) => setShopPhone(e.target.value)} placeholder={t.auth.shop.registerPhonePlaceholder} />
                    ...
                    <div>
                        ...
                        <TextInput id="shop_address" value={shopAddress} className="mt-1 block w-full border border-[#cfc3ac] bg-white text-slate-900 placeholder-slate-400" onChange={(e) => setShopAddress(e.target.value)} placeholder={t.auth.shop.registerAddressPlaceholder} />
