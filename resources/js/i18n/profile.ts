    ...
    fr: {
        ...
        form: {
            ...
            delete: {
                ...
                modalDescription: 'Cette action est irréversible. Sont supprimés avec votre compte : vos boutiques, vos produits et votre stock, vos ventes, factures, devis et avoirs, vos clients et fournisseurs, ainsi que les comptes de votre personnel. Aucune restauration n\'est possible depuis l\'application. Entrez votre mot de passe pour confirmer.',
    ...
    en: {
        ...
        form: {
            ...
            delete: {
                ...
                modalDescription: 'This action is irreversible. Deleting your account also deletes: your shops, your products and stock, your sales, invoices, quotes and credit notes, your customers and suppliers, and your staff\'s accounts. Nothing can be restored from within the app. Enter your password to confirm.',
